# Lorenz_JanusCursor (research archive)

Internal snapshot of the Janus dual-cursor free-run harness and survey logs.
**Public demo:** [`examples/Lorenz/`](../../examples/Lorenz/) (spotlight example;
major rework upcoming). This folder is for research follow-up only — not linked
from the SDK tour.
...
| [`comp.md`](comp.md) | CONV_CHANNELS 1/2/4 free-run comparison |
| [`../README.md`](../README.md) | Research Topics index (internal) |
...
| [`examples/Lorenz/`](../../examples/Lorenz/) | **Public** Lorenz example (spotlight; rework in progress) |
