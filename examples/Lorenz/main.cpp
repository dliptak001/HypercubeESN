...
int main()
{
    ...
    // Stage 2
    /////////////////////////////////////////////////////////////////////////
    constexpr uint64_t kEsn = 7934791766227647176ull;//8982357012682103037;//696634088797950509ull; // one of the top ranked seeds from SeedSweep
    ...
    FreeRun(/*dim=*/kDim,
                   ...
                   /*spectral_radius=*/kSpectralRadius,
                   /*input_scaling=*/kInputScaling,
                   /*orbit_seed=*/342920212748715133ull,
                   /*weights_stem=*/kWeightsPath,
                   /*freerun_steps=*/2000);
    ...
    FreeRun(/*dim=*/kDim,
               ...
               /*spectral_radius=*/kSpectralRadius,
               /*input_scaling=*/kInputScaling,
               /*orbit_seed=*/2053785022979524342ull,
               /*weights_stem=*/kWeightsPath,
               /*freerun_steps=*/2000);
    ...
    FreeRun(/*dim=*/kDim,
               ...
               /*spectral_radius=*/kSpectralRadius,
               /*input_scaling=*/kInputScaling,
               /*orbit_seed=*/4381562556728633053ull,
               /*weights_stem=*/kWeightsPath,
               /*freerun_steps=*/2000);
}
